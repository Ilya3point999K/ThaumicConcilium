...
public class ShaderHelper {
    ...
    private static final String PREFIX = "/assets/thaumicconcilium/shaders/";
    ...
    public static void useShader(int shader, ShaderCallback callback) {
        ...
        if (shader != 0) {
            ...
            ARBShaderObjects.glUniform1iARB(time, Minecraft.getMinecraft().renderViewEntity.ticksExisted);
            if (callback != null) {
