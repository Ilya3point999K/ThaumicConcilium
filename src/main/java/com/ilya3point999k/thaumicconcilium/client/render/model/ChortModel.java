...
public class ChortModel extends ModelBase
{
    ...
    public ChortModel(float p_i1148_1_)
    {
        this(p_i1148_1_, 0.0F, 64, 32);
    }

    public ChortModel(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_)
    {
        ...
        tail = new ModelRenderer(this, 56, 18);
        tail.addBox(0F, -4F, 8F, 0, 11, 3);
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        if (this.onGround > -9990.0F)
        {
            ...
            this.tail.rotateAngleY = this.bipedBody.rotateAngleY;
