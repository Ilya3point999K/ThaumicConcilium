...
import com.ilya3point999k.thaumicconcilium.common.golems.ai.GolemBurlakAI;
...
public class BurlakGolemCore extends AdditionalGolemCore {
    @Override
    public void setupGolem(EntityGolemBase golem) {

        golem.tasks.addTask(6, new GolemBurlakAI(golem));
    ...
    public String getUnlocalizedName() {
        return ThaumicConcilium.MODID+".core.burlak";
    }

    @Override
    public ItemStack getItem() {
        return new ItemStack(TCItemRegistry.golemCores, 1, 2);
    }
}